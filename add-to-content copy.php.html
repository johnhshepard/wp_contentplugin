...
<input type="hidden" name="<?php echo $hidden_field_name; ?>" value="Y">
			...
			<td width="20%"><input type="text" maxlength="7" size="6" value="<?php echo esc_attr( $options['top']['bc'] ); ?>" name="atc_settings[top][bc]" id="color1" /></td>
		</tr>

                <tr valign="top">
<input type="hidden" name="<?php echo $hidden_field_name; ?>" value="Y">
			<th scope="row"><?php _e('Text color', 'atc-menu' ); ?></th>
			<td width="20%"><input type="text" maxlength="7" size="6" value="<?php echo esc_attr( $options['top']['tc'] ); ?>" name="atc_settings[top][tc]" id="color2" /></td>
		</tr>
...
<input type="hidden" name="<?php echo $hidden_field_name; ?>" value="Y">
			<th scope="row"><?php _e('Background color', 'atc-menu' ); ?> </th>
			<td width="20%"><input type="text" maxlength="7" size="6" value="<?php echo esc_attr( $options['bottom']['bc'] ); ?>" name="atc_settings[bottom][bc]" id="color3" /></td>
		</tr>
                
                <tr valign="top">
<input type="hidden" name="<?php echo $hidden_field_name; ?>" value="Y">
			<th scope="row"><?php _e('Text color', 'atc-menu' ); ?> </th>
			<td width="20%"><input type="text" maxlength="7" size="6" value="<?php echo esc_attr( $options['bottom']['tc'] ); ?>" name="atc_settings[bottom][tc]" id="color4" /></td>
		</tr>
